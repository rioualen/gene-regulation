...
#parameter.file <- "~/BeatriceRoche/reports/report_DEG_broche_parameters.R"
parameter.file <- "/home/lkhamvongsa/mountrsatlocal/Mathilde/reports/rna-seq_DEG_parameters.R"
...
# View(result.table)
  ...
  deseq2.result.file <- paste(sep = "", prefix["comparison_file"], "DESeq2.tab")
  comparison.summary[i,"deseq2"] <- deseq2.result.file
  write.table(x = deseq2.result.table, row.names = FALSE, 
              file = file.path(dir.base, deseq2.result.file), sep = "\t", quote=FALSE)
  ...
  edger.result.file <- paste(sep="", prefix["comparison_file"], "edgeR.tab")
  comparison.summary[i,"edger"] <- edger.result.file
  
  write.table(x = edger.result.table, row.names = FALSE, 
              file = file.path(dir.base, edger.result.file), sep = "\t", quote=FALSE)
  ...
  write.table(x = result.table, row.names = FALSE,
              file = file.path(dir.base, result.file), sep = "\t", quote=FALSE)
  ...
  deg.file.up <- paste(sep = "", 
                    prefix["comparison_file"], 
                    "_", suffix.deg, "_selected_DEG_up.tab")
  comparison.summary[i,"deg.table.up"] <- deg.file.up
  write.table(x = result.table[up.genes, selected.columns], row.names = FALSE,
              file = file.path(dir.base, deg.file.up), sep = "\t", quote=FALSE)
  ...
  deg.file.down <- paste(sep = "", 
                    prefix["comparison_file"], 
                    "_", suffix.deg, "_selected_DEG_down.tab")
  comparison.summary[i,"deg.table.down"] <- deg.file.down
  write.table(x = result.table[down.genes, selected.columns], row.names = FALSE,
              file = file.path(dir.base, deg.file.down), sep = "\t", quote=FALSE)
