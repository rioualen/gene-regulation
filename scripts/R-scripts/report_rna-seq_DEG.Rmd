...
opts_knit$set(base.dir=dir.main) ## Set the working directory for knitr (generating HTML and pdf reports)
setwd(dir.main) ## Set the working directory for the console
...
# View(result.table)
  ...
  write.table(x = result.table[up.genes, selected.columns], row.names = FALSE,
              file = deg.file.up, sep = "\t", quote=FALSE)
  ...
  write.table(x = result.table[down.genes, selected.columns], row.names = FALSE,
              file = deg.file.down, sep = "\t", quote=FALSE)
