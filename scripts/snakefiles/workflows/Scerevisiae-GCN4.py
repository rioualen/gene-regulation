...
## Config
configfile: "scripts/snakefiles/workflows/Scerevisiae-GCN4.yml"
...
PEAKCALLER="homer_peaks macs2-qval" + config["macs2"]["qval"] + "_peaks macs14-pval" + config["macs14"]["pval"] + "_peaks swembl-R" + config["swembl"]["R"]# + " bPeaks_allGenome"#"macs14-pval" + config["macs14"]["pval"] + "_peaks"spp-fdr" + config["spp"]["fdr"] + "
...
rule all: 
	...
	"""
	input: GRAPHICS, IMPORT, BWA_INDEX, MAPPING, PEAKS, PEAK_MOTIFS
