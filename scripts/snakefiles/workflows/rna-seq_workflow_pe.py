...
## Config
configfile: "examples/RNA-seq_Ecoli_FNR_GSE41190/RNA-seq_Ecoli_FNR_GSE41190.yml"
...
rule all: 
	...
	"""
	input: IMPORT #,  RAW_QC, GRAPHICS, BAM_STATS, PEAKS, QC, GENOME_COVERAGE_GZ, GENOME_ANNOTATIONS, VISU
