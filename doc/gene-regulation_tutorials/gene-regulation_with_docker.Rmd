---
title: "Running the gene-regulation pipeline with Docker"
author: "Claire Rioualen"
date: "April 25, 2016"
output: html_document
---

## Installer docker (et docker io ?)

## Télécharger les données sur l'hôte et créer un répertoire pour les résultats
...
mkdir /data/results/GSE20870

## Récupérer et lancer le Docker en partageant les dossiers data et results (-v /path/on/host/:/path/on/docker:)

docker pull rioualen/gene-regulation:0.3
docker run -v /data/results/GSE20870/:/data/results/GSE20870/ -v /data/GSE20870/:/data/GSE20870/ -it rioualen/gene-regulation:0.3 /bin/bash

## Dans le Docker, lancer le pipeline

source ~/bin/ngs_bashrc
snakemake -s scripts/snakefiles/workflows/factor_workflow.py


-> le ngs_bashrc est voué à disparaître
