...
You can enter the following commands directly. 
...
```
You can also choose another path and then create symlinks.
...
docker run -v /data/results/GSE20870/:/data/results/GSE20870/ -v /data/source/GSE20870/:/data/source/GSE20870/ -it rioualen/gene-regulation:1.0 /bin/bash
```
