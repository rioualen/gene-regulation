...
```{shell}
sudo apt-get -y install zlib1g-dev                              # samtools dependency (workflows 1-6)
sudo apt-get -y install libncurses5-dev libncursesw5-dev        # samtools dependency (workflows 1-6)

sudo apt-get -y install r-base-core                             # Rsamtools dependency (workflows 4-6)
sudo pip3 install "rpy2<2.5.6"                                  # Rsamtools dependency (workflows 4-6)

sudo pip3 install pyyaml                                        # Config management (workflows 5-6)
```
### Samtools
