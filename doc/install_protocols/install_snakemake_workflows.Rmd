...
Make sure to provide the right amount of RAM and CPU, according to the amount of data, the tools you want to use, and what you actually have on your local.
...
**/!\\** Need version 3.4.1
```
sudo pip3 install snakemake --upgrade
```
...
# France Génomique ChIP-seq project - Celegans H3K27me3
...
```
rsync -ruptvl rioualen@10.1.1.133:~/Desktop/workspace/fg-chip-seq/data/Celegans-H3K27me3 data/
```

## Genome

```
rsync -ruptvl rioualen@10.1.1.133:~/Desktop/workspace/fg-chip-seq/genomes/ce10/BWAIndex/ce10.fa genomes/ce10/BWAIndex/
```

## Running the pipeline

```
cd ~/Desktop/workspace/fg-chip-seq
snakemake -s scripts/snakefiles/workflows/Celegans-H3K27me3.py -j 4
```
