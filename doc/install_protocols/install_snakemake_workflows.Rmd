...
To know more about the tools themselves, better check the [wiki/informatics section](https://github.com/rioualen/gene-regulation/blob/master/doc/wiki-fg/informatics.md). 
...
HOMER can also with custom genomes in FASTA format and gene annotations in GTF format.
