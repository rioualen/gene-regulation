...
---
  ...
  * [Creating a virtual machine (VM)](#creating-a-virtual-machine-vm)
    * [Creating a VM on the IFB cloud](#creating-a-vm-on-the-ifb-cloud)
  ...
  * [Installing programs and dependencies](#installing-programs-and-dependencies)
    * [Clone the gene-regulation repository](#clone-the-gene-regulation-repository)
    * [Run makefile to install all required dependencies](#run-makefile-to-install-all-required-dependencies)
  * [Executing snakemake workflows](#executing-snakemake-workflows)
    * [Download source data](#download-source-data)
      * [Virtual Box](#virtual-box)
      * [IFB cloud](#ifb-cloud)
    * [Execute workflow](#execute-workflow)
  * [Visualizing results](#visualizing-results)
    * [Installing and running the X2Go client (IFB cloud)](#installing-and-running-the-x2go-client-ifb-cloud)
    * [Visualize results](#visualize-results)
      * [FastQC](#fastqc)
      * [IGV](#igv)
  * [Export appliance (VBox VM)](#export-appliance-vbox-vm)
